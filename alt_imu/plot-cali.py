...
A = np.array([[ 24.999, -2.2491, -1.3498],  # 'A^-1' matrix from Magneto
              [-2.2491, 31.01654, 01.9074],
              [-1.3498, 1.907398, 38.2915]])
# 'Combined bias (b)' vector from Magneto
b = np.array([ -147.060810, 515.443687, -3609.629282])

# Read raw data and apply calibration
rawData = np.genfromtxt('mag_data_1.txt',
